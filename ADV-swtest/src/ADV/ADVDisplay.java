...
//
	...
	public void toggleR(boolean pressR, Measurements measurements ){
		if (pressR)
		{
			measurements.setshield_cmd("R");
			tglbtnR.setBackground(Color.GREEN);
			tglbtnR.setForeground(Color.BLACK);
			tglbtnD.setBackground(Color.WHITE);
			tglbtnD.setForeground(Color.BLACK);
		}
		else
		{
			measurements.setshield_cmd("");
			tglbtnR.setBackground(Color.WHITE);
			tglbtnR.setForeground(Color.BLACK);
			tglbtnD.setBackground(Color.WHITE);
			tglbtnD.setForeground(Color.BLACK);
	...
	public void toggleD(boolean pressD, Measurements measurements ){
		if (pressD)
		{
			measurements.setshield_cmd("D");
			tglbtnD.setBackground(Color.WHITE);
